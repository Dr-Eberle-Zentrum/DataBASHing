...
knitr::asis_output('<a href="http://www.youtube.com/watch?v=C-89jT0pUso?t=7"
                   title="Bashinho - #03 Befehle für das Rechtemanagement (chmod, chown, chgrp) [6 min]"
                   ><img src="http://img.youtube.com/vi/C-89jT0pUso/0.jpg"></a>')
```
...
```{r, include=knitr::is_html_output(), echo=F}
knitr::asis_output('<a href="http://www.youtube.com/watch?v=n8OqvSW7GFc"
                   title="Pedagogy - compress - decompress files using gzip & bzip2 in linux | tar command to manage compressed files [12 min]"
                   ><img src="http://img.youtube.com/vi/n8OqvSW7GFc/0.jpg"></a>')
```
...
```{r, include=knitr::is_html_output(), echo=F}
knitr::asis_output('Download: <a href="files.pdf" title="Download PDF Version">PDF Version</a> dieses Tutorials.')
```
