...
[![](http://img.youtube.com/vi/EhuHvJwUMKY/0.jpg)](http://www.youtube.com/watch?v=EhuHvJwUMKY?t=7 "Bashino - #05 Daten sortieren (sort uniq sort) [5 min]")
...
[![](http://img.youtube.com/vi/2_lgnCzwUEM/0.jpg)](http://www.youtube.com/watch?v=2_lgnCzwUEM "(en) Pedagogy - working with data files | cut command | paste command | join command | colrm command in linux [10 min]")
